...
import vista.ComputadorAgregar;

/**
 *
 * @author Nacho
 */
public class ControladorComputadorAgregar {
    //private Vista vista;
    ComputadorAgregar vista;
    private Computador modelo;

    public ControladorComputadorAgregar(ComputadorAgregar v, Computador m)
    {
        this.vista = v;
        this.modelo = m;        
    }
     ...
     public void inicializar() throws InstantiationException, IllegalAccessException, Exception
    {
        ...
        this.vista.cargartarjetaVideo(TarjetaVideo);
       ...
       public void create() throws IllegalAccessException, Exception{
           if (!validarProce()){
             return;
         }
